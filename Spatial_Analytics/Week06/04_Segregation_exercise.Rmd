...
date: "14/03/2021 updated `r format(Sys.time(), '%B %d, %Y')`"
output: 
  html_document:
    toc: true
    toc_float: true
...
#install.packages("devtools") #select 1 for all in console
...
#This shows that 800 is the best bandwidth in the data. 
```
...
seg10 <- spseg(
    pts = preston_crime, 
    h = bw_choice$h, #we choose the h bandwidth as our parameter
    opt = 3,
    ntest = 10, #10 as the sample for the dataset
    proc = FALSE)
