...
#Firstly we choose are target image to compare the similarities to:
...
#writing a csv-file where the two columns will be Filename and Distance
...
for result in sorted_results:
    ...
    #Now writing our sliced names and sliced results to the csv-file tothe outpath and appending each image name and its distance.
    #This time 'a' is used instead of 'w' because we are appending and don't want to overwrite the Filename and Distance written in earlier.
